						...
						<GridItem display="grid" gap={6}>
							...
							<Card>
								<Flex direction="column" gap={6}>
									<Flex justify="space-between" align="center" gap={6}>
										...
										<chakra.span bg={watch('status') === 'Published' ? 'brand.default' : watch('status') === 'Draft' ? 'yellow.default' : watch('status') === 'Disabled' && 'red.default'} borderRadius="full" h={4} w={4} />
									</Flex>
							...
							<Card>
								<Flex direction="column" gap={6}>
									...
									<Text fontSize="xs">Once the product is published, sales data will begin to be collected.</Text>
								</Flex>
							</Card>
